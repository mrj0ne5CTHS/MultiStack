# MultiStack — MultiBoard Tile Stacker
...
5. Adjust the inter-tile gap if needed (default 0.20mm)
...
The separation gap causes the printer to deposit a single layer of air between each tile — just enough for them to be pulled apart by hand when the print is done.
...
MultiBoard is designed by [Jonathan Odom](https://www.multiboard.io/). MultiStack is an unofficial community utility and is not affiliated with or endorsed by the MultiBoard project.
